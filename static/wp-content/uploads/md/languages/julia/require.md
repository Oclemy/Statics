[`Base.require`](https://docs.julialang.org/../../base/base/#Base.require) is responsible for loading modules and it also manages the precompilation cache. It is the implementation of the `import` statement.
