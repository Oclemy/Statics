...
- [Concurrent UI Patterns (Experimental)](#concurrent-ui-patterns-experimental)
  ...
  - [The Three Steps {#the-three-steps}](#the-three-steps-the-three-steps)
    - [Default: Receded → Skeleton → Complete {#default-receded-skeleton-complete}](#default-receded--skeleton--complete-default-receded-skeleton-complete)
    - [Preferred: Pending → Skeleton → Complete {#preferred-pending-skeleton-complete}](#preferred-pending--skeleton--complete-preferred-pending-skeleton-complete)
    ...
    - [Suspense Reveal "Train" {#suspense-reveal-train}](#suspense-reveal-train-suspense-reveal-train)
  ...
  - [Other Patterns {#other-patterns}](#other-patterns-other-patterns)
    ...
    - [Deferring a Value {#deferring-a-value}](#deferring-a-value-deferring-a-value)
