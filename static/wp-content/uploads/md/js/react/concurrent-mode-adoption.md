...
- [Adopting Concurrent Mode (Experimental)](#adopting-concurrent-mode-experimental)
  - [Installation {#installation}](#installation-installation)
    - [Who Is This Experimental Release For? {#who-is-this-experimental-release-for}](#who-is-this-experimental-release-for-who-is-this-experimental-release-for)
    - [Enabling Concurrent Mode {#enabling-concurrent-mode}](#enabling-concurrent-mode-enabling-concurrent-mode)
  - [What to Expect {#what-to-expect}](#what-to-expect-what-to-expect)
    - [Migration Step: Blocking Mode {#migration-step-blocking-mode}](#migration-step-blocking-mode-migration-step-blocking-mode)
    - [Why So Many Modes? {#why-so-many-modes}](#why-so-many-modes-why-so-many-modes)
