...
<activity android:name\="com.example.app.ChildActivity" android:label\="@string/title\_child\_activity" android:parentActivityName\="com.example.app.MainActivity"  \> <!-- Parent activity meta-data to support API level 4+ --> <meta-data android:name\="android.support.PARENT\_ACTIVITY" android:value\="com.example.app.MainActivity"  />
</activity>
