...
for Android, such as Basecamp, Pinterest and more. For more information, check out the resource on Android development.
...
For more information, check out the Kotlin/Native documentation.
...
On the JVM side, the main build tools include Gradle, Maven, 
Ant, and [Kobalt](https://beust.com/kobalt/home/index.html). There are also some build tools available
...
The best place to start is [our website](https://kotlinlang.org). From there you can download the compiler, 
...
on the Books page. For more books, see the community-maintained list at [kotlin.link](https://kotlin.link/). 
