...
in the Working with command-line compiler tutorial. 
...
For details, see Gradle compiler options.
...
Enable usages of API that requires opt-in with a requirement annotation with the given 
