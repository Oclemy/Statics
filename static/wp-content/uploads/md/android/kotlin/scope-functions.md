...
of an object. When you call such a function on an object with a lambda expression provided, it forms a
...
Each scope function uses one of two ways to access the context object: as a lambda receiver
