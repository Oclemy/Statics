...
usages (similar to how content of inline functions is inlined to call sites).
...
Inline class properties cannot have backing fields. They can only have simple computable 
...
Because inline classes may be represented both as the underlying value and as a wrapper, referential equality 
...
At first sight, inline classes seem very similar to type aliases. Indeed, both seem to introduce 
