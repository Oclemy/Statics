...
You can filter maps with the [`filter()`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/filter.html) function as well as other collections.
...
Mutable maps offer map-specific write operations.
