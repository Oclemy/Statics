...
inside any number of other named classes, named interfaces, or named objects. Subclasses can have any visibility
...
> `when` expressions on `expect` sealed classes in the common code of multiplatform projects still 
