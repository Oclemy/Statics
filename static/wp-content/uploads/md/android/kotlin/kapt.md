...
> but have no plans to implement new features. Please use the Kotlin Symbol Processing API (KSP) for annotation processing.
>
{type="warning"}
...
4. To use the newest Kotlin features with kapt, for example, repeatable annotations, 
...
When you use the custom JDK home feature in the Kotlin Gradle plugin,
...
> Caching for annotation processors' classloaders in kapt is Experimental.
...
Note that incremental annotation processing requires incremental compilation
