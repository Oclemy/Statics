...
[Deploying to Production](https://flask.palletsprojects.com/../../deploying/) for a list of many different ways to host your
application.
...
[set up a new virtualenv](https://flask.palletsprojects.com/../../installation/#install-create-env), then install the
file with `pip`.
...
[`SECRET_KEY`](https://flask.palletsprojects.com/../../config/#SECRET_KEY "SECRET_KEY"). This should be changed to some random bytes in
...
See [Deploying to Production](https://flask.palletsprojects.com/../../deploying/) for a list of many different ways to host
...
Continue to [Keep Developing!](https://flask.palletsprojects.com/../next/).
